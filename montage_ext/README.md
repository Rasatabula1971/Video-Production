...
Also here (later): the loader that reads `subjects/steelpan/` and injects the
profile, copyright rules, and fact corpus into openmontage's `creative-intake`
and `research-director` stages.
